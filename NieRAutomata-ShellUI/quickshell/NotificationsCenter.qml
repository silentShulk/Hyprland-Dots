    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            ScrollView {
                ...
                Layout.fillHeight: true   // <- this now claims the leftover space instead of a bare Item
                clip: true
            ...
            IslandBadge {
                ...
                onBadgeClicked: {
                    for (let i=0; i<SystemStats.notificationHistory.count; i++) {
                        SystemStats.removeFromHistory(SystemStats.notificationHistory.get)
                    }
                }
            }
        }
